...
export default class CreatePet extends Component {
    ...
    onChangeLocState(e) {
        axios.get(`${serverURL}/api/location/cities/${e.target.value}`)
            .then(res => res.data)
            .then(listOfCities => {
                this.setState({
                                  cities: listOfCities
    ...
    onSetType(animalType) {
        ...
        axios.get(`${serverURL}/api/petfinder/breeds/${animalType}`)
            .then(res => res.data)
            .then(typesOfBreeds => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post(`${serverURL}/pets/add`, pet)
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                         ...
                         {this.state.type !== "Scales, Fins & Other"
                          ...
                          <div className="form-group">
                              ...
                              <select ref="userInput"
                                  ...
                                  <option value="" disabled selected>Primary Breed</option>
                                  {
                                      this.state.breedses.map((breed) => {
                                          return <option
                                              key={breed.name}
                    ...
                    <div className="form-group">
                        ...
                        <small className="form-text text-muted">Only one for now, but don't worry
                            you can add more later</small>
                    </div>
                    <div className="form-group">
